...
import { Mail, Linkedin, Globe, Info, Flag } from 'lucide-react';
...
interface ReportAdvisorTableRowProps {
  advisor: Advisor;
  index: number;
}

export function ReportAdvisorTableRow({ advisor, index }: ReportAdvisorTableRowProps) {
